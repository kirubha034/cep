...
public class TestModif {
	...
	public void createEvent(){
	    ...
	    fillRequestDetails(eventDate,ciscoAttendee,accTeamObjective,customerPartnerObjectives,oppCount, compSituationText, 
    ...
    public void selectEventType(){
    	System.out.println("Select Event Type");
            ...
            selectedEventType=driver.findElement(By.xpath("//div[@ng-repeat='et in engTypeSrv.allEngTypes']["+result+"]/md-radio-button/div[2]")).getText();
...
//         
   ...
   public void fillRequestDetails(String eventDate,String ciscoAttendee, String accTeamObjective,String customerPartnerObjectives, String oppCount, String compSituationText, 
	     ...
	     /*for(int i=0;i<3;i++){
	    	 System.out.println(i+"loop checking for scro;;");
    ...
    public void fillPartnerCustomerTab(){
    	
    	    //Assert.assertTrue(wait.until(ExpectedConditions.titleContains("Customer")));
    		driver.findElement(By.xpath("//md-input-container[label[text()='Attendee Name']]/input")).sendKeys("Attendee Name - 1");
        	...
        	driver.findElement(By.xpath("//div/md-input-container[label[text()='Title']]/input")).sendKeys("Attendee Title 1");
        	 clickNext();	
    }
