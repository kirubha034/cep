...
public class SendFileEmail {
    ...
    final String[] emailList={"kirubha034@gmail.com","kirubha.r@ariveguru.com"};
    ...
    try {
       ...
       // message.setRecipients(Message.RecipientType.BCC,
        ...
        String file1="C:\\Users\\kirajama\\Desktop\\WS-L-Eclipse\\CEP\\test-output\\emailable-report.html";
        //String fileName1 = "file.txt"; //change to your attachment filename
        String fileName1="\\emailable-report.html";
